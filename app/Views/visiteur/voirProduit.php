    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div>
                ...
                <hr />
                <?php echo anchor('Visiteur/listerProduitsMarque/' . $marque["NOMARQUE"], $marque["NOM"]);
                echo '<hr/>';
                echo anchor('Visiteur/listerProduitsCategorie/' . $categorie["NOCATEGORIE"], $categorie["LIBELLE"]);
                echo '<hr/>'; ?>
                <div>
                ...
                <?php if ($session->get('statut') == 3) { ?>
                    ...
                    <span class="produit"> <a class="btn ajoutpanier <?php if ($unProduit["DISPONIBLE"] == 0) {
                                                                            echo 'disabled';
                                                                        } ?>" href="<?php echo site_url('Visiteur/ajouterPanier/' . $unProduit["NOPRODUIT"]);  ?>">Ajouter au panier</a></span>
                <?php } ?>
