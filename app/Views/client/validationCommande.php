     ...
     <div class="col">
         ...
         <div class="row align-items-center">
             ...
             <table class="table">
                 ...
                 <tr>
                     <td><a href="<?php echo site_url('visiteur/afficherPanier'); ?>" class="btn hvr-hover">Modifier la commande</a></td>
                     <td colspan="2"></td>
                     <?php if ($total > 0) { ?>
                         <td>
                         ...
                         <?php if (!empty($session->get('statut'))) { ?>
                             <td>
                                 ...
                                 <form method="POST" action="<?php echo $serveurOK; ?>">
                                     ...
                                     <input class="btn hvr-hover" type="submit" value="Procéder au paiement">
                                 </form>
     ...
     <div class="col-md-3">
         <div class="border border-secondary">
             ...
             <table class="table">
                 ...
                 <tr>
                     <td class="text-center" colspan="2"><a class="btn hvr-hover" href="<?php echo site_url('Visiteur/s_enregistrer') ?>">Modifier</a></td>
                 </tr>
             </table>
         </div>
     </div>
