...
<div class="all-title-box">
  <div class="container">
    <div class="row">                
    <h2>Modifier les identifiants du site</h2>        
    </div>
  </div>
</div>
<!-- fin de banderole -->
...
<?php
  ...
  echo form_open('AdministrateurSuper/modifierIdentifiantsBancaires');
...
<?php
  echo form_submit('submit', 'Modifier','class="btn hvr-hover"');
  ?> <br/><br/> <?php
  echo form_close();
