...
<div class="row">
    ...
    <div class="col">
        ...
        <td>
                ...
                <a href="<?= base_url().'index.php/Visiteur/voirProduit/'.$produit['NOPRODUIT']?>"><img src="<?= base_url().'/assets/images/'.$produit['NOMIMAGE'].'.jpg'?>" width="80"/></a>
                <?php } else{?>
                    <a href="<?= base_url().'index.php/Visiteur/voirProduit/'.$produit['NOPRODUIT']?>"><img src="<?= base_url().'/assets/images/nonimage.jpg'?>" width="80"/></a>
                <?php } ?>
            </td>
                <td><a  href="<?= base_url().'index.php/Visiteur/voirProduit/'.$produit['NOPRODUIT']?>"><?php echo $produit['LIBELLE']; ?></a></td>
...
<td colspan='6' class='text-right'><h4>Total: <?php echo $commande['TOTALTTC']; ?>€</h4></td></tr>
    ...
    <div class="col-sm-1">
           <a class="btn hvr-hover" href="<?= site_url('AdministrateurEmploye/commandeTraitees/'.$commande['NOCOMMANDE']) ?>">Valider la commande</a>        
    </div>
</div>
